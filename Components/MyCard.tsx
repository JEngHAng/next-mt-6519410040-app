...
import picprofile from "@/assets/images/myprofile.png";
...
export default function MyCard() {
  return (
    // ปรับ p-4 เป็น p-2 และลด max-w จาก 360px เป็น 320px
    <div className="flex items-center justify-center p-2 bg-transparent">
      <div className="w-full max-w-[320px] bg-[#1e1e1e] rounded-[35px] p-6 flex flex-col shadow-2xl border border-white/5">
        
        {/* Name Header - ชิดซ้ายและลดขนาด font */}
        <div className="w-full text-left">
          <h1 className="text-white text-2xl mb-4 tracking-tight font-semibold">
            <span className="text-orange-500">S</span>aranchai
          </h1>
        </div>

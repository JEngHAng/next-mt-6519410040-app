...
export default function SideMenu({ activeTab = 'home' }: SideMenuProps) {
  // กำหนด href ให้ตรงกับชื่อโฟลเดอร์ใน app directory ของคุณ
  const menuItems = [
    { icon: <Home size={18} />, id: 'home', href: '/' },
    { icon: <User size={18} />, id: 'aboutme', href: '/aboutme' },
    { icon: <Layers size={18} />, id: 'eduexp', href: '/eduexp' },
    { icon: <LayoutList size={18} />, id: 'spec', href: '/spec' },
    { icon: <Briefcase size={18} />, id: 'projects', href: '/projects' },
    { icon: <Terminal size={18} />, id: 'skills', href: '/skills' },
